...
if strcmp(flag,'Train')
    dataset_dir='/workspace/workspace/Hand-Pointnet/preprocess_nyu/dataset/train/';
    centersID = fopen('/workspace/workspace/Hand-Pointnet/preprocess_nyu/center_train_refined.txt');
